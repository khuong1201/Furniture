...
use Modules\Promotion\Domain\Repositories\{
    PromotionRepositoryInterface,
    PromotionProductRepositoryInterface
};
use Modules\Promotion\Infrastructure\Repositories\{
    EloquentPromotionRepository,
    EloquentPromotionProductRepository
};
...
class PromotionServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(PromotionProductRepositoryInterface::class, EloquentPromotionProductRepository::class);
    }
