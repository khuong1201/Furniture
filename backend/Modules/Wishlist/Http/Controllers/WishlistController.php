...
class WishlistController extends BaseController
{
    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(content: new OA\JsonContent(
            ...
            properties: [
                new OA\Property(property: "product_uuid", type: "string", format: "uuid", example: "a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11")
            ]
        )),
        responses: [
            new OA\Response(
    ...
    {
        // Bất kỳ user đã login nào cũng có quyền tạo wishlist cho chính mình
        // Authorization logic nằm ở việc $request->user()->id
        ...
        return response()->json(ApiResponse::success(null, $result['message']));
    }
    ...
    public function destroy(string $uuid): JsonResponse
    {
        ...
        return response()->json(ApiResponse::success(null, 'Item removed from wishlist'));
    }
}